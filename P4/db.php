<?php
    ...
    class AccesoBD
    {
        ...
        public function editarProducto($id_producto, $nombre_producto, $marca, $precio, $descripcion, $portada) //actualizar etiquetas de un producto. 
        {
            ...
            $actualizacionProducto = $this->conexion->prepare("UPDATE productos SET nombre_producto = ?, marca = ?, precio = ?, descripcion = ?, url_imagen_principal = ? WHERE id_producto = ?");
            $actualizacionProducto->bind_param("ssdssi", $nombre_producto, $marca, $precio, $descripcion, $portada, $id_producto);
